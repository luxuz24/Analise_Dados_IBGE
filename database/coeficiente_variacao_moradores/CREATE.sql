...
DROP TABLE IF EXISTS coeficiente_variacao_moradores;

-- Cria a nova tabela para o Coeficiente de Variação dos "Moradores"
CREATE TABLE coeficiente_variacao_moradores (
    "Cod."                                   INTEGER,
