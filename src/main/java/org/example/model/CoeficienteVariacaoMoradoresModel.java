...
/**
 * Classe Modelo que representa os dados da tabela "coeficiente_variacao_moradores".
 ...
 */
public class CoeficienteVariacaoMoradoresModel extends DadosIbge {

    /**
     * Construtor padrão.
     */
    public CoeficienteVariacaoMoradoresModel() {
        super();
    }
