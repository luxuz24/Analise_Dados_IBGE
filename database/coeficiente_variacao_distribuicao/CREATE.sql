...
DROP TABLE IF EXISTS coeficiente_variacao_distribuicao;

-- Cria a nova tabela para o Coeficiente de Variação da Distribuição Percentual
CREATE TABLE coeficiente_variacao_distribuicao (
    "Cod."                                   INTEGER,
